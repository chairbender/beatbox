...
public class ChuckBoard {
    ...
    public static void playExample(Example e) {
        ...
        args[0] = e.getChuckId();
        OSCMessage msg = new OSCMessage("/playExample", args);
        try {
            sender.send(msg);
    ...
    public static void playMetronomeAndMark(int bpm, int countIn) {
        ...
        args[0] = bpm;
        args[1] = countIn;
        OSCMessage msg = new OSCMessage("/startMetroAndMark", args);
        try {
            sender.send(msg);
        } catch (IOException ex) {
            ex.printStackTrace();
    ...
    public static void stopMetronome() {
        ...
        OSCMessage msg = new OSCMessage("/stopMetro", args);
        try {
            sender.send(msg);
        } catch (IOException ex) {
            ex.printStackTrace();
    ...
    public static void play(SoundClass sound, double volume) {
        ...
        try {
            sender.send(new OSCMessage("/playSound", args));
        } catch (IOException ex) {
            ex.printStackTrace();
        }
    }
    ...
    public static void setThreshold(double db) {
        ...
        args[0] = (float) (db);
        try {
            sender.send(new OSCMessage("/setThreshold", args));
        } catch (IOException ex) {
            ex.printStackTrace();
        }
    }
    ...
    public static void setChuckTrainingMode(boolean train) {
        ...
        try {
            sender.send(new OSCMessage("/trainingMode", args));
        } catch (IOException ex) {
            ex.printStackTrace();
        }
    }
    ...
    public static void saveRecordedExamples(final List<Example> lst, String file) throws IOException {
                ...
                Platform.runLater(new Runnable() {
                    public void run() {
                        ...
                        try {
                            ...
                            sender.send(new OSCMessage("/exampleList",exs));
                        } catch (IOException ex) {
        ...
        sender.send(new OSCMessage("/saveRecordedExamples",args));
    ...
    public static void loadRecordedExamples(String file) {
        ...
        args[0] = file;
        try {
            sender.send(new OSCMessage("/loadRecordedExamples", args));
    ...
    private static void removeLoop(int loopId) {
        ...
        args[0] = loopId;
        try {
            sender.send(new OSCMessage("/removeLoop", args));
        } catch (IOException ex) {
            ex.printStackTrace();
        }
    }
    ...
    public static void addSound(Sound snd, int classValue) {
        ...
        args[1] = classValue;
        try {
            sender.send(new OSCMessage("/addSound", args));
        } catch (IOException ex) {
            ex.printStackTrace();
        }
    }
    ...
    public static void setClassVolume(SoundClass snd, double volume) {
        ...
        try {
            sender.send(new OSCMessage("/setSoundGain", args));
        } catch (IOException ex) {
            ex.printStackTrace();
        }
    }
    ...
    static void setVolume(double level) {
        ...
        try {
            ...
            sender.send(new OSCMessage("/setMasterVolume", ar));
        } catch (IOException ex) {
            Logger.getLogger(ChuckBoard.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
