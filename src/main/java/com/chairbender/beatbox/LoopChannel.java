...
import com.chairbender.beatbox.LooperStates.LooperState;
...
public class LoopChannel extends Parent implements ClassificationListener {
    ...
    private ObjectProperty<Granularity.GranularityType> quantization = new SimpleObjectProperty<>(Granularity.GranularityType.QUARTER_NOTE);
    private final Rectangle rctBorder;

    public ObjectProperty<Granularity.GranularityType> quantizationProperty() {
        return quantization;
    }
    private Loop loop;
    ...
    public void startPlaying() {
        ...
        //TODO: Figure out what this class was supposed to do WekinatorBeatboxLogger.logTrackPlayed(loopChannelId);
     ...
     */
    void setQuantization(Granularity.GranularityType quant) {
