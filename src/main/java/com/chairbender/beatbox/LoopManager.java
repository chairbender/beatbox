...
//        getChildren().add(r1);
        ...
        choiceBox.getItems().add(new Granularity(Granularity.GranularityType.QUARTER_NOTE));
        choiceBox.getItems().add(new Granularity(Granularity.GranularityType.EIGTH_NOTE));
        choiceBox.getItems().add(new Granularity(Granularity.GranularityType.SIXTEENTH_NOTE));
